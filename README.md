...
font-awesome-propshaft provides the
...
* The remainder of the font-awesome-propshaft project is licensed under the
  [MIT License](http://opensource.org/licenses/mit-license.html).
